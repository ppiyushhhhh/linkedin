...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LinkedIn" },
      { name: "description", content: "LinkedIn is a professional networking platform for building connections and growing your career." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "LinkedIn" },
      { property: "og:description", content: "LinkedIn is a professional networking platform for building connections and growing your career." },
